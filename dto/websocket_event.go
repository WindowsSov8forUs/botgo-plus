...
var intentEventMap = map[Intent][]EventType{
	...
	IntentGuildMembers:  {EventGuildMemberAdd, EventGuildMemberUpdate, EventGuildMemberRemove, EventGuildMemberDelete},
	IntentGroupMembers:  {EventGroupMemberAdd, EventGroupMemberRemove, EventGroupJoinRequest},
	IntentGuildMessages: {EventMessageCreate, EventMessageDelete},
	IntentGroupMessages: {EventGroupMessageCreate, EventGroupAddRobot, EventGroupDelRobot,
		EventGroupMsgReceive, EventGroupMsgReject, EventGroupAtMessageCreate,
		EventC2CMessageCreate, EventSubscribeMsgStatus, EventC2CFriendAdd, EventC2CFriendDel},
