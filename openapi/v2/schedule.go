...
func (o *openAPIv2) ListSchedules(ctx context.Context, channelID string, since uint64) ([]*dto.Schedule, error) {
...
func (o *openAPIv2) GetSchedule(ctx context.Context, channelID, scheduleID string) (*dto.Schedule, error) {
	rsp, err := o.request(ctx).
		SetResult(dto.Schedule{}).
		SetPathParam("channel_id", channelID).
...
// CreateSchedule 创建日程
func (o *openAPIv2) CreateSchedule(ctx context.Context, channelID string, schedule *dto.Schedule) (*dto.Schedule, error) {
	rsp, err := o.request(ctx).
		SetResult(dto.Schedule{}).
		SetPathParam("channel_id", channelID).
...
// ModifySchedule 修改日程
func (o *openAPIv2) ModifySchedule(ctx context.Context,
...
// DeleteSchedule 删除日程
func (o *openAPIv2) DeleteSchedule(ctx context.Context, channelID, scheduleID string) error {
	_, err := o.request(ctx).
		SetPathParam("channel_id", channelID).
		SetPathParam("schedule_id", scheduleID).
