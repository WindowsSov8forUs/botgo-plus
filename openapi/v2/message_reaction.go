...
func (o *openAPIv2) CreateMessageReaction(ctx context.Context,
...
func (o *openAPIv2) DeleteOwnMessageReaction(ctx context.Context,
	channelID, messageID string, emoji dto.Emoji) error {
	_, err := o.request(ctx).
		SetPathParam("channel_id", channelID).
		SetPathParam("message_id", messageID).
...
func (o *openAPIv2) GetMessageReactionUsers(ctx context.Context, channelID, messageID string, emoji dto.Emoji,
