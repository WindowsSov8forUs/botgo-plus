...
func (o *openAPIv2) MemberAddRole(
...
func (o *openAPIv2) MemberDeleteRole(
	ctx context.Context, guildID string, roleID dto.RoleID, userID string,
	value *dto.MemberAddRoleBody,
) error {
	if value == nil {
...
func (o *openAPIv2) GuildMember(ctx context.Context, guildID, userID string) (*dto.Member, error) {
...
func (o *openAPIv2) GuildRoleMembers(
...
func (o *openAPIv2) DeleteGuildMember(ctx context.Context, guildID, userID string, opts ...dto.MemberDeleteOption) error {
