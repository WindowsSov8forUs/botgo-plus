...
func (o *openAPIv2) PostRole(ctx context.Context, guildID string, role *dto.Role) (*dto.UpdateResult, error) {
	if role.Color == 0 {
...
func (o *openAPIv2) PatchRole(ctx context.Context,
...
func (o *openAPIv2) DeleteRole(ctx context.Context, guildID string, roleID dto.RoleID) error {
	_, err := o.request(ctx).
		SetPathParam("guild_id", guildID).
		SetPathParam("role_id", string(roleID)).
